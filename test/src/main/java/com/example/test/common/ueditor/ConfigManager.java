package com.cys.wtdp.common.ueditor;

import com.cys.wtdp.common.ueditor.define.ActionMap;
...
public final class ConfigManager {
	...
	private ConfigManager ( String rootPath, String contextPath, String uri ) throws FileNotFoundException, IOException {
		...
		//this.originalPath = "D:/data/config/config.json";
		//this.originalPath = "D:/wtch-api-new/src/main/resources/config.json";
		this.originalPath = "E:/WTDP-CS/WTDP-API/src/main/resources/config.json";
		//this.originalPath = "/data/wtch_api/config/config.json";
		this.initEnv();
...
//		this.parentPath = file.getParent();
		...
		String configContent = this.readFile( this.originalPath );
		System.out.printf("ueditor配置》》》》》》》》》》》》》》》》》》》》》》");
		System.out.printf(configContent);
		//更改获取配置文件的方式
